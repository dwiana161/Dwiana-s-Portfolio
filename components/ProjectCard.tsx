...
const ProjectCard = ({ image, title, text, link, tech}: Props ) => {
  ...
  return (
    <div className="flex flex-col p-4 sm:p-5 w-full sm:w-[500px] rounded-md border-3 border-orange-800 cursor-pointer">
      <motion.div
        className="w-full"
      ...
      >
        ...
        <h3 className="mt-3 text-lg sm:text-xl text-orange-800 font-extrabold font-serif">
          {title}
        </h3>
        <p className="text-orange-800 text-sm sm:text-base mt-1 mb-2 text-justify font-serif">
          {text}
        </p>
